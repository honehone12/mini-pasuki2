...
func (c *PasskeyClient) UpdateOneID(id binid.BinId) *PasskeyUpdateOne {
...
func (c *PasskeyClient) DeleteOneID(id binid.BinId) *PasskeyDeleteOne {
...
func (c *PasskeyClient) Get(ctx context.Context, id binid.BinId) (*Passkey, error) {
	return c.Query().Where(passkey.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PasskeyClient) GetX(ctx context.Context, id binid.BinId) *Passkey {
...
type (
	hooks struct {
		Passkey, User []ent.Hook
	}
	inters struct {
		Passkey, User []ent.Interceptor
	}
)
